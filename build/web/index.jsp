<%-- 
    Document   : index.html
    Created on : 3 oct 2022, 12:15:09
...
<html>
    ...
    <body>
        ...
        <header>
            ...
            <nav class="navbar navbar-expand-md navbar-light btn-blue">
        ...
        <section class="inicio" id="inicio">
            <div class="content">
                <h3>ESTUDIANTES</h3>
                <p1>Bienvenido a el sistema de control de estudiantes para su salud, ingrese en formularios para evaluar</p1>
            </div>
        ...
        <section class="Estudiante" id="Estudiante">
                ...
                <button type="button" name="btn_nuevo" id="btn_nuevo" class="boton"input type="color" value="#FF5733" data-toggle="modal" data-target="#modal_empleado" onclick="limpiar()">AGREGAR ESTUDIANTE</button>
      ...
      <div class="modal-content">
        <div class="modal-body">
            ...
            <form action="sr_estudiante" method= "post" class="form-group">
                ...
                <input type="text" name="txt_nombres" id="txt_nombres" class="form-control" placeholder="Ejemplo: Javier Eduardo" required>
                
                <label for="lbl_apellidos" ><b>Apellidos</b></label>
                <input type="text" name="txt_apellidos" id="txt_apellidos" class="form-control" placeholder="Ejemplo: Salazar Nájera" required>
                
                <label for="lbl_direccion" ><b>Direccion</b></label>
                <input type="text"  name="txt_direccion" id="txt_direccion" class="form-control" placeholder="Ejemplo: zona/calle/ciudad" required>
                ...
                <input type="email" name="txt_correo" id="txt_correo" class="form-control" placeholder="Ejemplo:Ejemplo@gmail.com" required>
